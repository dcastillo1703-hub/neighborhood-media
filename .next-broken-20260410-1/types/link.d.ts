...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/api/approvals/${SafeSlug<T>}`
    | `/api/campaigns/${SafeSlug<T>}`
    | `/api/client-memberships/${SafeSlug<T>}`
    | `/api/integrations/connections/${SafeSlug<T>}`
    | `/api/integrations/connections/${SafeSlug<T>}/check`
    | `/api/integrations/sync-jobs/${SafeSlug<T>}`
    | `/api/integrations/sync-jobs/${SafeSlug<T>}/run`
    | `/api/operations/tasks/${SafeSlug<T>}`
    | `/api/planner-items/${SafeSlug<T>}`
    | `/api/posts/${SafeSlug<T>}`
    | `/api/publishing/${SafeSlug<T>}`
    | `/api/weekly-metrics/${SafeSlug<T>}`
    | `/api/workspace/members/${SafeSlug<T>}`
